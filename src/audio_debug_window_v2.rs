                ...
                div()
                    ...
                    .child(
                        panel(
                            ...
                            chart(155.0, history_canvas(snapshot.phase_history.clone(), -1.0, 1.0, color(0x70_d6_ff))),
                        )
                        .flex_1()
                        .min_w(px(0.0)),
                    )
                    .child(
                        panel(
                            ...
                            Some("瞬态裕量趋势".into()),
                            chart(155.0, history_canvas(snapshot.crest_history.clone(), 0.0, 30.0, color(0xff_c8_57))),
                        )
                        .flex_1()
                        .min_w(px(0.0)),
                    ),
