...
pub const CONTEXT_LAYER_1_BIAS: [f32; 16] = [
    f32::from_bits(0x3E5B_9B84),
    f32::from_bits(0xC031_AE93),
    f32::from_bits(0xBECC_9FE9),
    f32::from_bits(0xBFE3_9601),
    f32::from_bits(0xC031_F07D),
    f32::from_bits(0x3EA0_B437),
    f32::from_bits(0xBE7B_2150),
    f32::from_bits(0x3F20_33F9),
    f32::from_bits(0xBE83_CC72),
    f32::from_bits(0xBF75_8EEB),
    f32::from_bits(0x3D02_63EC),
    f32::from_bits(0xBF3B_2B07),
    f32::from_bits(0xBED8_6325),
    f32::from_bits(0xBF12_087B),
    f32::from_bits(0xBF87_9E36),
    f32::from_bits(0xBEEB_8E19),
];

pub const CONTEXT_LAYER_2_BIAS: [f32; 16] = [
    f32::from_bits(0xBFC3_28B8),
    f32::from_bits(0x3C1E_9004),
    f32::from_bits(0xBC95_6F95),
    f32::from_bits(0xBFDE_CDBA),
    f32::from_bits(0xBE1C_6600),
    f32::from_bits(0xBD8C_2C70),
    f32::from_bits(0x3CA0_A0E8),
    f32::from_bits(0x3A87_502C),
    f32::from_bits(0xBD86_4DD3),
    f32::from_bits(0xBF56_6A9F),
    f32::from_bits(0xBEC3_4AFE),
    f32::from_bits(0xBFB1_F5B7),
    f32::from_bits(0xBD36_3B87),
    f32::from_bits(0xBDDB_A0CB),
    f32::from_bits(0xBF58_02B6),
    f32::from_bits(0xBEAC_23B2),
];

pub const CONTEXT_LAYER_3_BIAS: [f32; 16] = [
    f32::from_bits(0x3DE1_4B18),
    f32::from_bits(0x3DE1_4A06),
    f32::from_bits(0x3DE1_4986),
    f32::from_bits(0x3DE1_4633),
    f32::from_bits(0x3DE1_47DB),
    f32::from_bits(0x3DE1_43C3),
    f32::from_bits(0x3DE1_3F7A),
    f32::from_bits(0x3DE1_4B2D),
    f32::from_bits(0x3DE1_42F6),
    f32::from_bits(0x3DE1_4313),
    f32::from_bits(0x3DE1_4BB9),
    f32::from_bits(0x3DE1_492C),
    f32::from_bits(0x3DE1_3E3C),
    f32::from_bits(0x3DE1_4C20),
    f32::from_bits(0x3DE1_4608),
    f32::from_bits(0x3DE1_4CCD),
];
...
mod tests {
    ...
    fn complete_annex_b_constructor_uses_only_static_tables() {
        ...
        assert_eq!(params.layer_1.kernel, &CONTEXT_LAYER_1_KERNEL[..]);
        assert_eq!(params.layer_2.kernel, &CONTEXT_LAYER_2_KERNEL[..]);
        assert_eq!(params.layer_3.kernel, &CONTEXT_LAYER_3_KERNEL[..]);
        assert_eq!(params.layer_1.bias, &CONTEXT_LAYER_1_BIAS[..]);
        assert_eq!(params.layer_2.bias, &CONTEXT_LAYER_2_BIAS[..]);
        assert_eq!(params.layer_3.bias, &CONTEXT_LAYER_3_BIAS[..]);
    }
}
